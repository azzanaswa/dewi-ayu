...
@section('content')
    <h3 class="page-title">@lang('Edit Divisi Organisasi')</h3>
    {!! Form::model($orgs, ['method' => 'PUT', 'enctype' => 'multipart/form-data', 'route' => ['admin.divisi-org.update', $orgs->id]]) !!}

    <div class="panel panel-default">
        <div class="panel-heading">
            @lang('Edit Divisi Organisasi')
        </div>
        
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('divisi', 'Divisi', ['class' => 'control-label']) !!}
                    ...
                    {!! Form::select('divisi[]', $divisis, old('divisi'), ['class' => 'form-control' ]) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('link', 'Link Asal*', ['class' => 'control-label']) !!}
