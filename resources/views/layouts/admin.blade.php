...
<link href="{{ url('profile/public/adminlte/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
<link rel="stylesheet" href="{{ url('profile/public/quickadmin/css') }}/select2.min.css"/>
<link href="{{ url('profile/public/adminlte/css/AdminLTE.min.css') }}" rel="stylesheet">
<link href="{{ url('profile/public/adminlte/css/skins/skin-blue.min.css') }}" rel="stylesheet">
<link rel="stylesheet"
...
<link href="{{ url('profile/public/css/admin.css') }}" rel="stylesheet" type="text/css">
...
<script src="{{ url('profile/public/quickadmin/js') }}/bootstrap.min.js"></script>
<script src="{{ url('profile/public/quickadmin/js') }}/select2.full.min.js"></script>
<script src="{{ url('profile/public/quickadmin/js') }}/main.js"></script>

<script src="{{ url('profile/public/adminlte/plugins/slimScroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ url('profile/public/adminlte/plugins/fastclick/fastclick.js') }}"></script>
<script src="{{ url('profile/public/adminlte/js/app.min.js') }}"></script>
<script>
